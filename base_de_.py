...
# print(f"MongoDB Connection URI: {URI}") # Added for debugging
# 
# @st.cache_resource
# def init_connection():
...
# 
#                <p>❤️ FC:
#                {mascota.get('Frecuencia_Cardiaca','')} ppm</p>
# 
#                </div>
#                """, unsafe_allow_html=True)
# 
...
# 
#             fecha_aplicacion = st.text_input(
#                 "Fecha Aplicación"
#             )
# 
#             fecha_caducidad = st.text_input(
#                 "Fecha Caducidad"
#             )
# 
#             contenido = st.text_input(
#                 "Contenido"
#             )
# 
#             dosis = st.text_input(
...
#             ):
# 
#                 coleccion_adoptante.delete_one(
#                     {"_id": adoptante["_id"]}
#                 )
# 
#                 st.success(
